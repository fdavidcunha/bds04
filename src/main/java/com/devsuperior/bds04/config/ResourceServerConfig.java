...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests()
			...
			.antMatchers(HttpMethod.GET, PUBLIC_GET).permitAll() // Rotas GET liberadas pra todos.
			.anyRequest().hasAnyRole("ADMIN");                   // Qualquer outra rota só é liberada por meio de login.
	}
}